...
function renderItemSprite(idOrName, customClass = "") {
  ...
  if (!meta) return "";
  return `<img src="${meta.iconUrl}" class="mc-item-sprite ${customClass}" alt="${meta.name}" loading="lazy" onerror="this.src='assets/items/minecraft_enchanted_book.png'">`;
}
...
/* ============================================================== */
/* 10. MOD TECHNICAL INDEX (43 MODS DATABASE)                     */
/* ============================================================== */
const modsDatabase = [
  {
    id: "cataclysm",
    ...
    keyItems: ["The Incinerator", "Monstrous Helm", "Ignitium Ingot", "Laser Gatling", "Tidal Claws"],
  ...
  },
  {
    ...
    keyItems: ["Dragon Egg", "Dragonsteel Sword", "Dragon Heart", "Gorgon Head"],
  ...
  },
  {
    ...
    description: "Populates every biome with 85+ realistic and mythical creatures, custom animations, taming mechanics, and the Void Worm boss.",
    deepDive: "Check the Animal Dictionary to discover habitat preferences and taming foods for all fauna. Summon the Void Worm in the End void using a Mysterious Worm to forge the Dimensional Carver.",
    keyItems: ["Animal Dictionary", "Dimensional Carver", "Void Worm Beak", "Tendon Whip"],
  ...
  },
  {
    ...
    roleClass: "content",
    icon: "💀",
    dependency: "Forge 1.20.1",
    jarName: "born_in_chaos-1.20.1-1.12.jar",
    description: "Introduces sinister undead nightmares, dark ritual transformations, and heavy bone weaponry.",
    deepDive: "Encounters scale at night and underground. Nightmarish stalkers like the Restless Spirit, Fallen Chaos Knight, and Glutton drop rare dark components used to forge heavy warhammers.",
    keyItems: ["Skull Breaker", "Dark Metal Ingot", "Nightmare Blade"],
  ...
  },
  {
    ...
    icon: "🧟",
    dependency: "Forge 1.20.1",
    jarName: "mutantmonsters-1.20.1-1.0.3.jar",
    description: "Spawns giant mutated variants of vanilla mobs with devastating shockwave attacks, earth throws, and boss drops.",
    deepDive: "Craft Chemical X by brewing Obsidian and Nether Wart. Splash vanilla mobs to mutate them into Mutant Zombies, Mutant Skeletons, Mutant Creepers, and Mutant Endermen.",
    keyItems: ["Chemical X", "Hulk Hammer", "Creeper Minion"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/mutant-monsters"
  },
  {
    id: "aether",
    name: "The Aether",
    ...
    jarName: "aether-1.20.1-1.4.1.jar",
    description: "The legendary sky dimension featuring floating celestial islands, Moa mounts, Zanite & Gravitite ores, and 3 iconic dungeon bosses.",
    deepDive: "Ignite a Glowstone frame with a Water Bucket. Explore Bronze Dungeons (Slider - Pickaxes only), Silver Dungeons (Valkyrie Queen), and Gold Dungeons (Sun Spirit).",
    keyItems: ["Gravitite Ore", "Zanite Ingot", "Moa Egg", "Valkyrie Cape", "Phoenix Bow"],
  ...
  },
  {
    ...
    description: "Expands the Deep Dark into an entirely new terrifying dimension called The Otherside.",
    deepDive: "Defeat a Warden to claim the Heart of the Deep. Right-click the central Reinforced Deepslate portal frame in an Ancient City to open the rift. Mine Gloomslate and Wardstone to craft Warden Armor with built-in Sonic Boom.",
    keyItems: ["Heart of the Deep", "Warden Helmet", "Sculk Transmitter", "Resonarium Ingot"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/deeper-and-darker"
  },
  {
    id: "terralith",
    name: "Terralith",
    ...
    roleClass: "content",
    icon: "🏔️",
    dependency: "None (Data-driven)",
    jarName: "Terralith_1.20.1_v2.5.4.jar",
    description: "Massively overhauls Overworld generation with nearly 100 stunning realistic and fantasy biomes using pure vanilla blocks.",
    deepDive: "Adds Yellowstone geothermal geysers, jagged Alpine peaks, Volcanic Calderas, Mirage Deserts, and underground cave biomes without adding foreign block types.",
    keyItems: ["Yellowstone Geysers", "Volcanic Basalt", "Alpine Glaciers"],
  ...
  },
  {
    ...
    jarName: "BiomesOPlenty-1.20.1-18.0.0.jar",
    description: "Adds over 50 vibrant biomes across the Overworld and Nether, complete with custom trees, foliage, flowers, and gemstones.",
    deepDive: "Explore Cherry Blossom Groves, Mystic Groves, Lavender Fields, and Redwood Forests. Mine Rubies, Sapphires, and Topaz for decorative and utility crafting.",
    keyItems: ["Ruby", "Sapphire", "Redwood Wood", "Magic Wood"],
  ...
  },
  {
    ...
    icon: "🌌",
    dependency: "None (Data-driven)",
    jarName: "Nullscape_1.20.1_v1.2.7.jar",
    description: "Reimagines The End dimension from the bedrock to world height with floating crystal spires, abyssal fissures, and inverted terrains.",
    deepDive: "Breathes scale into the End dimension by raising the height ceiling to 384 blocks, creating terrifying vertical chasms and crystalline void spikes.",
    keyItems: ["Crystal Spires", "Void Fissures", "Shadow Bridges"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/nullscape"
  },
  {
    id: "create",
    name: "Create",
    ...
    description: "Kinetic rotational engineering, automated factories, conveyor belts, mechanical contraptions, and steerable rail trains.",
    deepDive: "Harness Stress Units (SU) from Water Wheels, Windmills, and multi-tier Steam Engines. Use Mechanical Presses, Mixers, Crushing Wheels, and Dynamic Trains with custom bogies.",
    keyItems: ["Andesite Alloy", "Brass Ingot", "Water Wheel", "Mechanical Press", "Rotation Speed Controller"],
  ...
  },
  {
    ...
    icon: "🔧",
    dependency: "Create",
    jarName: "create_stuff_additions-1.20.1-2.0.4.jar",
    description: "Expands Create with Brass Jetpacks, Kinetic Exo-Armors, portable drill tools, and automated weapons.",
    deepDive: "Craft pressurized Brass Jetpacks for unlimited aerial maneuvering while building kinetic structures. Equip Brass and Zinc armor with built-in speed modifiers.",
    keyItems: ["Brass Jetpack", "Copper Armor", "Mechanical Drill"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/create-stuff-additions"
  },
  {
    ...
    icon: "📖",
    dependency: "Create",
    jarName: "create_enchantment_industry-1.20.1-1.2.9.jar",
    description: "Automates the enchantment process with liquid experience (Hyper Experience), mechanical printers, and automatic disenchanting.",
    deepDive: "Transform mob farm drops into Liquid Experience, pipe it into Enchanting Disenchanters, and mass-print enchanted books using the Mechanical Printer.",
    keyItems: ["Disenchanter", "Mechanical Printer", "Hyper Experience Tank"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/create-enchantment-industry"
  },
  {
    id: "tconstruct",
    ...
    description: "Custom modular multi-material tool crafting, high-temperature multi-block smelteries, and fluid alloy smelting.",
    deepDive: "Build a Seared Brick multi-block Smeltery with lava fuel. Melt Cobalt and Netherite to cast Manyullyn alloys. Modify tools with Lapis (Fortune/Looting), Quartz (Sharpness), and Diamonds (Durability).",
    keyItems: ["Smeltery Controller", "Seared Tank", "Manyullyn Ingot", "Cleaver Cast"],
  ...
  },
  {
    ...
    icon: "📚",
    dependency: "Forge 1.20.1",
    jarName: "Mantle-1.20.1-1.11.2.jar",
    description: "Core foundation library for Slimeknights mods, providing books, fluid matrixes, and multi-block rendering.",
    deepDive: "Provides shared multi-block controller logic, fluid rendering pipelines, and book formatting engines.",
    keyItems: ["Mantle Core", "Fluid Pipeline API"],
  ...
  },
  {
    ...
    roleClass: "content",
    icon: "✨",
    dependency: "Curios API, GeckoLib, PlayerAnimator",
    jarName: "irons_spellbooks-1.20.1-3.2.1.jar",
    description: "RPG magic system with 10 distinct spell schools, wizard armor sets, spell scrolls, and boss encounters.",
    deepDive: "Craft an Inscription Table and Scroll Forge. Discover Blood, Evocation, Fire, Holy, Ice, Lightning, Nature, and Ender magic schools. Equip high-tier Spellbooks in your Curios slot.",
    keyItems: ["Diamond Spellbook", "Scroll Forge", "Arcane Anvil", "Fireball Scroll", "Lightning Bolt Scroll"],
  ...
  },
  {
    ...
    icon: "🧙",
    dependency: "Forge 1.20.1",
    jarName: "hexerei-0.4.2.jar",
    description: "Atmospheric witchcraft mod featuring cauldrons, flying brooms, herbalism drying racks, and witch covens.",
    deepDive: "Harvest sage and swamp herbs. Blend infusions in a heated Cauldron to craft Mahogany or Willow Brooms that can fly freely across the world.",
    keyItems: ["Witch Cauldron", "Willow Broom", "Drying Rack", "Herbal Herb Bag"],
  ...
  },
  {
    ...
    icon: "📜",
    dependency: "Forge 1.20.1",
    jarName: "so_many_enchants-1.20.1-0.9.1.jar",
    description: "Adds dozens of powerful new enchantments up to Supreme tiers for weapons, tools, bows, and armors.",
    deepDive: "Discover Supreme Sharpness (+8.0 dmg), Advanced Looting, Purification, Critical Strike, and combo-stacking enchantments in dungeon vaults.",
    keyItems: ["Supreme Sharpness Tome", "Advanced Protection", "Combo Star Tome"],
  ...
  },
  {
    ...
    description: "Gentle culinary and agricultural expansion featuring cooking pots, cutting boards, organic soil, and feast meals.",
    deepDive: "Simmer ingredients in a heat-source Cooking Pot to cook Shepard's Pie, Stuffed Pumpkin, and Roast Chicken for the Comfort and Nourishment buffs.",
    keyItems: ["Cooking Pot", "Iron Knife", "Cutting Board", "Skillet", "Rich Soil"],
  ...
  },
  {
    ...
    roleClass: "content",
    icon: "🥩",
    dependency: "Farmer's Delight",
    jarName: "NethersDelight-1.20.1-1.4.1.jar",
    description: "Brings culinary cuisine to the Nether using Strider meat, Hoglin loins, and crimson fungi.",
    deepDive: "Hunt Hoglins to prepare succulent Barbecue loins and Magma Crepes that provide Fire Resistance and hearty saturation.",
    keyItems: ["Hoglin Loin", "Strider Stew", "Nether Skewer"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/nethers-delight"
  },
  {
    id: "aquaculture",
    name: "Aquaculture 2",
    ...
    icon: "🎣",
    dependency: "Forge 1.20.1",
    jarName: "Aquaculture-1.20.1-2.4.8.jar",
    description: "Expands fishing with over 30 new fish species, custom tackle boxes, bait, and Neptunium armor.",
    deepDive: "Equip iron/gold/diamond fishing rods with custom bobbers and line. Fish up treasure lockboxes to discover ancient Neptunium weapons and water-breathing gear.",
    keyItems: ["Neptunium Ingot", "Tackle Box", "Diamond Fishing Rod", "Neptunium Bow"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/aquaculture"
  },
  {
    ...
    icon: "🎒",
    dependency: "Curios API",
    jarName: "sophisticatedbackpacks-1.20.1-3.20.4.jar",
    description: "Modular upgradeable backpacks with auto-pickup, feeding, smelting, crafting, and void filters.",
    deepDive: "Equip directly in the Curios Back slot (press 'B'). Upgrade from Leather -> Iron -> Gold -> Diamond -> Netherite for massive inventory space and up to 5 upgrade modules.",
    keyItems: ["Diamond Backpack", "Netherite Backpack", "Auto-Smelt Upgrade", "Magnet Upgrade", "Feeding Upgrade"],
  ...
  },
  {
    ...
    jarName: "sophisticatedstorage-1.20.1-0.8.6.jar",
    description: "Adds modular Barrels, Chests, and Shulker Boxes with tier upgrades and inventory sorting modules.",
    deepDive: "Apply tier upgrades directly onto chests and barrels in-world. Insert Compact/Stack upgrades to hold thousands of items per slot.",
    keyItems: ["Netherite Barrel", "Tier Upgrade", "Stack Upgrade"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/sophisticated-storage"
  },
  {
    id: "waystones",
    name: "Waystones",
    ...
    description: "Teleportation network with crafted or naturally occurring Waystones, Warp Scrolls, and Warp Stones.",
    deepDive: "Activate Waystones in villages and structures. Craft a reusable Warp Stone or single-use Warp Scrolls to teleport instantly from anywhere back to home base.",
    keyItems: ["Waystone", "Warp Stone", "Warp Scroll", "Bound Scroll"],
  ...
  },
  {
    ...
    version: "15.3.0",
    category: "Utility",
    role: "Essential Utility",
    roleClass: "support",
    icon: "🔍",
    dependency: "Forge 1.20.1",
    jarName: "jei-1.20.1-forge-15.3.0.jar",
    description: "Item and recipe indexing tool with recipe lookups ('R'), usage inspection ('U'), and bookmarking ('A').",
    deepDive: "The heart of every modpack. Filter with '@mod' for specific mods, '#tag' for item tags, or '$food' for ore dictionaries.",
    keyItems: ["Recipe Matrix", "Bookmark Drawer", "Tag Search"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/jei"
  },
  {
    id: "jer",
    ...
    icon: "📊",
    dependency: "JEI",
    jarName: "JustEnoughResources-1.20.1-1.4.0.jar",
    description: "Integrates with JEI to display mob drops, dungeon chest loot chances, plant drops, and world-gen ore y-levels.",
    deepDive: "Click on any ore or mob drop in JEI to see exact height spawn distributions, drop percentages, and looting multipliers.",
    keyItems: ["Ore Distribution Graphs", "Dungeon Loot Tables"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/just-enough-resources-jer"
  },
  {
    id: "jade",
    name: "Jade / WAILA",
    ...
    icon: "🏷️",
    dependency: "Forge 1.20.1",
    jarName: "Jade-1.20.1-forge-11.7.1.jar",
    description: "Informative HUD overlay that shows block contents, mob health, current harvest tool, and mod ownership.",
    deepDive: "Look at any block or entity to see live container fluids, harvest level requirements, and remaining mob hit points.",
    keyItems: ["HUD Tooltip", "Block Inspection"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/jade"
  },
  {
    id: "curios",
    name: "Curios API",
    ...
    description: "Flexible accessory inventory framework adding slots for rings, amulets, belts, charms, and backpacks.",
    deepDive: "Opens an extra accessory slot wheel next to the character inventory screen. Required by Iron's Spells, The Aether, and Sophisticated Backpacks.",
    keyItems: ["Curios Slot Grid", "Ring Slot", "Charm Slot"],
  ...
  },
  {
    ...
    description: "Visual HUD indicator for food saturation levels and potential hunger restoration when holding food.",
    deepDive: "Visualizes exact saturation values on your hunger bar and shows potential healing when hovering over culinary dishes.",
    keyItems: ["Saturation HUD", "Exhaustion Overlay"],
  ...
  },
  {
    ...
    description: "Enhances inventory management with RMB dragging, LMB dragging, and mouse wheel item scrolling.",
    deepDive: "Hold right click to drag 1 item across slots; hold left click to collect all matching items; scroll wheel to quickly move items between containers.",
    keyItems: ["RMB Drag", "LMB Quick-Collect", "Wheel Scroll"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/mouse-tweaks"
  },
  {
    id: "controlling",
    name: "Controlling",
    version: "12.0.2",
    category: "Utility",
    role: "Keybind Utility",
    roleClass: "support",
    icon: "⌨️",
    dependency: "Forge 1.20.1",
    jarName: "Controlling-forge-1.20.1-12.0.2.jar",
    description: "Adds a search bar and conflict filter to the Minecraft keybind options menu.",
    deepDive: "Filter keybinds by key, mod name, or conflicting bindings to resolve overlapping controls across large mod collections.",
    keyItems: ["Conflict Filter", "Key Search"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/controlling"
  },
  {
    id: "rubidium",
    name: "Embeddium / Rubidium",
    version: "0.3.18",
    category: "Performance",
    role: "Performance Mod",
    roleClass: "performance",
    icon: "⚡",
    dependency: "Forge 1.20.1",
    jarName: "embeddium-0.3.18+mc1.20.1.jar",
    description: "Sodium fork for Forge, dramatically improving FPS, chunk rendering, and CPU thread efficiency.",
    deepDive: "Reduces OpenGL driver overhead, optimizes chunk mesh generation, and provides smooth 120+ FPS gameplay with large modpacks.",
    keyItems: ["Chunk Multithreading", "Memory Allocator", "FPS Booster"],
  ...
  },
  {
    ...
    description: "Iris Shaders port for Forge, enabling modern shaderpack support (Complementary, BSL) at high framerates.",
    deepDive: "Press 'K' to toggle shaders in-game. Fully compatible with Embeddium chunk rendering pipeline for ray-traced shadows and water reflections.",
    keyItems: ["Shaderpack Support", "Dynamic Lighting"],
  ...
  },
  {
    ...
    description: "Reduces Minecraft's RAM consumption by several gigabytes through blockstate and model deduplication.",
    deepDive: "Deduplicates in-memory blockstate instances and item model arrays, cutting client heap allocation from 8GB down to 4-5GB.",
    keyItems: ["RAM Reducer", "Model Deduplication"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/ferritecore"
  },
  {
    id: "modernfix",
    name: "ModernFix",
    ...
    icon: "🚀",
    dependency: "Forge 1.20.1",
    jarName: "modernfix-forge-5.17.0+mc1.20.1.jar",
    description: "Fixes memory leaks, reduces world launch load times by up to 50%, and optimizes entity ticking.",
    deepDive: "Patches Forge registry overhead, optimizes DFU (DataFixerUpper) schemas, and minimizes RAM footprint during world transitions.",
    keyItems: ["Fast Launch Engine", "Memory Leak Patch"],
  ...
  },
  {
    ...
    version: "0.3.3",
    category: "Performance",
    role: "Server Performance",
    roleClass: "performance",
    icon: "⚡",
    dependency: "Forge 1.20.1",
    jarName: "canary-mc1.20.1-0.3.3.jar",
    description: "Port of Lithium for Forge, providing comprehensive mathematical optimizations for AI, collisions, and redstone.",
    deepDive: "Optimizes physics calculations, mob pathfinding, block ticking, and chunk loading without altering gameplay rules.",
    keyItems: ["Physics Optimizer", "AI Pathfinding Engine"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/canary"
  },
  {
    id: "entityculling",
    name: "Entity Culling",
    version: "1.6.2",
    category: "Performance",
    role: "Client Performance",
    roleClass: "performance",
    icon: "👁️",
    dependency: "Forge 1.20.1",
    jarName: "entityculling-forge-1.6.2-mc1.20.1.jar",
    description: "Uses asynchronous raytracing to skip rendering tiles and entities occluded by walls, saving massive GPU cycles.",
    deepDive: "Culls rendering of mobs, chests, and item frames hidden behind solid blocks, boosting framerates inside dense bases.",
    keyItems: ["Raytraced Occlusion", "Tile Entity Culling"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/entity-culling"
  },
  {
    id: "citadel",
    name: "Citadel",
    ...
    icon: "🏰",
    dependency: "Forge 1.20.1",
    jarName: "citadel-1.20.1-2.4.9.jar",
    description: "Advanced mob animation, entity AI, and bone transform library powering Alex's Mobs, Ice and Fire, and Cataclysm.",
    deepDive: "Handles procedural IK animations, entity pathing mesh calculations, and custom bounding boxes for complex bosses.",
    keyItems: ["Bone Transform Engine", "IK Animation Framework"],
  ...
  },
  {
    ...
    icon: "🦎",
    dependency: "Forge 1.20.1",
    jarName: "geckolib-forge-1.20.1-4.4.4.jar",
    description: "3D animation engine for armor, items, blocks, and entities with keyframed easing and particle controllers.",
    deepDive: "Provides keyframe export compatibility from Blockbench directly into Iron's Spells and custom gear animations.",
    keyItems: ["Keyframe Engine", "Particle Controller"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/geckolib"
  },
  {
    id: "cloth_config",
    ...
    icon: "⚙️",
    dependency: "Forge 1.20.1",
    jarName: "cloth-config-11.1.118-forge.jar",
    description: "In-game graphical user interface configuration library used by dozens of client-side quality-of-life mods.",
    deepDive: "Allows real-time tweaking of mod options through stylish in-game setting menus.",
    keyItems: ["GUI Config Menu", "Client Options"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/cloth-config"
  },
  {
    id: "architectury",
    ...
    version: "9.2.14",
    category: "Library",
    role: "Multi-loader API",
    roleClass: "support",
    icon: "🏛️",
    dependency: "Forge 1.20.1",
    jarName: "architectury-9.2.14-forge.jar",
    description: "Intermediary API facilitating cross-platform mod development between Forge, NeoForge, and Fabric.",
    deepDive: "Standardizes registries, network packets, and event dispatchers across multiple mod loaders.",
    keyItems: ["Universal Registry", "Network API"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/architectury-api"
  },
  {
    id: "patchouli",
    name: "Patchouli",
    ...
    icon: "📖",
    dependency: "Forge 1.20.1",
    jarName: "Patchouli-1.20.1-84-FORGE.jar",
    description: "Data-driven guidebook creation engine powering in-game lore manuals, quest books, and system guides.",
    deepDive: "Renders formatted in-game guidebooks with multi-block structure visualizations and interactive bookmarks.",
    keyItems: ["Guidebook Engine", "Multi-block Visualizer"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/patchouli"
  },
  {
    id: "spark",
    name: "Spark Profiler",
    ...
    icon: "📈",
    dependency: "Forge 1.20.1",
    jarName: "spark-1.10.53-forge.jar",
    description: "High-precision performance CPU, memory, and TPS profiler for pinpointing lag sources and tick delays.",
    deepDive: "Run '/spark sampler' in chat to generate interactive flame graphs pinpointing misbehaving mob entities or redstone lag.",
    keyItems: ["TPS Sampler", "Heap Analyzer", "Flame Graphs"],
    docUrl: "https://www.curseforge.com/minecraft/mc-mods/spark"
  }
];
